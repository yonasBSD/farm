...
## [2.2.0](https://github.com/yonasBSD/farm/compare/farmfe_compiler-v2.1.0...farmfe_compiler-v2.2.0) - 2026-06-14

### Added

- *(plugin-vue)* port unplugin-vue to a Farm Rust plugin powered by fervid ([#2300](https://github.com/yonasBSD/farm/pull/2300))
- migrate all Rust and JavaScript plugins to current repo ([#2282](https://github.com/yonasBSD/farm/pull/2282))
- add support for emitting multiple resources in farm library mode ([#2280](https://github.com/yonasBSD/farm/pull/2280))
- *(core)* support umd & css.transformToScript ([#2254](https://github.com/yonasBSD/farm/pull/2254))

### Fixed

- *(core)* SWC plugin runtime deadlock during emotion example build ([#2313](https://github.com/yonasBSD/farm/pull/2313))
- fixed the issue of nested public and output config ([#2271](https://github.com/yonasBSD/farm/pull/2271))
- *(v2)* #2262 HMR does not work with Qiankun framework ([#2263](https://github.com/yonasBSD/farm/pull/2263))
- cjs require doesn't be handled correctly when targetEnv is library ([#2259](https://github.com/yonasBSD/farm/pull/2259))

### Other

- Add empty changeset for lint/type-check fixes ([#2306](https://github.com/yonasBSD/farm/pull/2306))
- upgrade Rust nightly to 2026-04-10 and align SWC crates to latest ([#2298](https://github.com/yonasBSD/farm/pull/2298))
- Update SWC related crates to latest version and ensure tests pass ([#2281](https://github.com/yonasBSD/farm/pull/2281))
