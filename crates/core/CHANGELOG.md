...
## [2.2.0](https://github.com/yonasBSD/farm/compare/farmfe_core-v2.1.0...farmfe_core-v2.2.0) - 2026-06-14
...
- add env manual control thread max nums ([#2249](https://github.com/yonasBSD/farm/pull/2249))
...
- reduce memory usage ([#2256](https://github.com/yonasBSD/farm/pull/2256))
