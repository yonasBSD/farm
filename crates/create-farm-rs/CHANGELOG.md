...
## [2.1.0](https://github.com/yonasBSD/farm/compare/create-farm-v2.0.1...create-farm-v2.1.0) - 2026-06-14
...
- deno create & add dry-run flag ([#2247](https://github.com/yonasBSD/farm/pull/2247))

### Other

- Add empty changeset for lint/type-check fixes ([#2306](https://github.com/yonasBSD/farm/pull/2306))
- sync v2 docs from code and rename docs/ to website/ ([#2283](https://github.com/yonasBSD/farm/pull/2283))
